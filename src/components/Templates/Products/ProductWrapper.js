        ...
        <>
            <div className="flex items-start flex-col lg:flex-row container xl:max-w-[94.52%] mx-auto gap-4 lg:gap-6">
                ...
                <section className="flex flex-col w-full gap-4 lg:gap-6">
                    <div className="relative hidden md:flex items-center justify-between gap-x-6 h-14 px-8 bg-lightGray3 rounded-2xl">
              ...
              <span className="flex items-center gap-2 font-Yekan-Medium text-base">
                <SortIcon className="w-5 h-5" /> مرتب سازی
                        ...
                        <ul className="relative flex items-center divide-x-reverse divide-x-2 divide-[#DFDFDF] gap-4 font-Yekan-Medium text-sm text-[#404040] h-full">
                            <li className="sort-btn sort-btn--active px-4" role="button">
                                <a href="#">جدیدترین</a>
                            </li>
                            <li className="sort-btn px-4" role="button">
                                <a href="#">قدیمی‌ترین</a>
                            </li>
                            <li className="sort-btn px-4" role="button">
                                <a href="#">گران‌ترین</a>

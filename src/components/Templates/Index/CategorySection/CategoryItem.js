        ...
        <div className="flex flex-col items-center sm:items-stretch gap-3   ">
            ...
            <div
                ...
                <div className="hidden md:flex flex-col">
                    <a  href={`/products/category/${param}`} className="inline-flex items-center gap-1">
            ...
            <a href={`/products/category/${param}`} className="md:hidden font-Yekan-Medium text-center mx-auto text-sm sm:text-xl  ">
                {title}</a>
        </div>
    );
}

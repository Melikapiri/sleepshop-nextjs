    ...
    return (
        <svg className={className} xmlns="http://www.w3.org/2000/svg" width={20} height={20} viewBox="0 0 20 20"
            ...
            <path
                ...
                stroke="#121111" strokeWidth="1.25" strokeMiterlimit={10} strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M9.10833 1.75L5 8.33333" stroke="#121111" strokeWidth="1.25" strokeMiterlimit={10}
